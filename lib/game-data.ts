...
export const STATS: StatDefinition[] = [
  { key: 'strength',     label: 'Strength',     emoji: '💪', icon: 'game-icons:stomp',            description: 'Raw damage output. Bigger number, bigger hurt.' },
  { key: 'agility',      label: 'Agility',      emoji: '⚡', icon: 'game-icons:wind-slap',        description: 'Attack order and dodge chance. Fast dinos go first and miss less.' },
  { key: 'constitution', label: 'Constitution', emoji: '❤️', icon: 'game-icons:scale-mail',       description: 'Your total HP pool. More constitution, more punishment you can take.' },
  { key: 'ferocity',     label: 'Ferocity',     emoji: '🔥', icon: 'game-icons:flaming-claw',     description: 'Critical hit chance. Sometimes you just snap.' },
  { key: 'hide',         label: 'Hide',         emoji: '🛡️', icon: 'game-icons:lamellar',         description: 'Natural armor. Reduces incoming damage. Great scales, fewer scrapes.' },
  { key: 'stamina',      label: 'Stamina',      emoji: '🫁', icon: 'game-icons:lungs',            description: 'Performance in long fights. Low stamina = growing tired after round 5.' },
  { key: 'jaw',          label: 'Jaw',          emoji: '🦷', icon: 'game-icons:tooth',            description: 'Critical hit multiplier. Does nothing on normal hits — but the higher your jaw, the more catastrophic your crits become. Pairs well with Ferocity.' },
  { key: 'cunning',      label: 'Cunning',      emoji: '🧠', icon: 'game-icons:brain',            description: 'Counter-attack and trap chance. Intelligence is a weapon too, apparently.' },
  { key: 'roar',         label: 'Roar',         emoji: '📢', icon: 'game-icons:bull-horns',        description: 'Your war cry rattles the enemy before the first blow, reducing their Ferocity and Agility.' },
]
...
export const SPECIES: Species[] = [
  {
    ...
    portraits: ['/images/species/tre1.png', '/images/species/tre2.png', '/images/species/tre3.png', '/images/species/tre4.png'],
  ...
  },
  {
    ...
    portraits: ['/images/species/vel1.png', '/images/species/vel2.png', '/images/species/vel3.png', '/images/species/vel4.png'],
  ...
  },
  {
    ...
    portraits: ['/images/species/tri1.png', '/images/species/tri2.png', '/images/species/tri3.png', '/images/species/tri4.png'],
  ...
  },
  {
    ...
    portraits: ['/images/species/ank1.png', '/images/species/ank2.png', '/images/species/ank3.png', '/images/species/ank4.png'],
  ...
  },
  {
    ...
    portraits: ['/images/species/spi1.png', '/images/species/spi2.png', '/images/species/spi3.png', '/images/species/spi4.png'],
  ...
  },
  {
    ...
    portraits: ['/images/species/pte1.png', '/images/species/pte2.png', '/images/species/pte3.png', '/images/species/pte4.png'],
  ...
  },
  {
    ...
    portraits: ['/images/species/pac1.png', '/images/species/pac2.png', '/images/species/pac3.png', '/images/species/pac4.png'],
  ...
  },
  {
    ...
    portraits: ['/images/species/ste1.png', '/images/species/ste2.png', '/images/species/ste3.png', '/images/species/ste4.png'],
...
export const TOWNS: TownDefinition[] = [
  {
    ...
    keeperEmoji: '🦕',
    keeperIcon: 'game-icons:dinosaur-rex',
  ...
  },
  {
    ...
    tavernKeeper: 'Voryn',
    keeperEmoji: '🏔️',
    keeperIcon: 'game-icons:mountaintop',
...
export const GEAR_SLOTS: { key: GearSlot; label: string; emoji: string; icon: string; description: string }[] = [
  { key: 'jaws',      label: 'Jaws',      emoji: '🦷', icon: 'game-icons:tooth',           description: 'Bite weapons and fang enhancements. One equipped at a time.' },
  { key: 'claws',     label: 'Claws',     emoji: '🤜', icon: 'game-icons:claws',            description: 'Strike weapons and gauntlets. One equipped at a time.' },
  { key: 'body',      label: 'Body',      emoji: '🛡️', icon: 'game-icons:chest-armor',      description: 'Armor, hides, and plating. One equipped at a time.' },
  { key: 'head',      label: 'Head',      emoji: '🎭', icon: 'game-icons:viking-helmet',    description: 'Helmets, horns, and masks. One equipped at a time.' },
  { key: 'tail',      label: 'Tail',      emoji: '📌', icon: 'game-icons:curled-tentacle',  description: 'Tail weapons and attachments. One equipped at a time.' },
  { key: 'accessory', label: 'Accessory', emoji: '💍', icon: 'game-icons:charm',            description: 'Charms, totems, and necklaces. One equipped at a time.' },
]
...
export const GEAR: GearTemplate[] = [
  ...
  { id: 'sharpened_bone',      name: 'Sharpened Bone',       slot: 'jaws',      emoji: '🦴', icon: 'game-icons:bone-gnawer',          levelReq: 1,  price: 75,   statBonus: { jaw: 1, strength: 1 },                  description: 'A bone. Someone sharpened it. The beginning of a dental strategy.' },
  { id: 'serrated_fang',       name: 'Serrated Fang',        slot: 'jaws',      emoji: '🦷', icon: 'game-icons:fangs',              levelReq: 3,  price: 240,  statBonus: { jaw: 2, ferocity: 1 },                  description: 'A large tooth, serrated and mounted. Goes in and doesn\'t come out clean.' },
  { id: 'croc_jaw_weapon',     name: 'Croc Jaw',             slot: 'jaws',      emoji: '🐊', icon: 'game-icons:croc-jaws',          levelReq: 6,  price: 550,  statBonus: { jaw: 3, strength: 2 },                  description: 'An actual crocodile jaw, mounted and wielded. Grubclaw considers this his masterwork.' },
  { id: 'volcanic_fang_blade', name: 'Volcanic Fang',        slot: 'jaws',      emoji: '🔥', icon: 'game-icons:fire-ring',          levelReq: 8,  price: 750,  statBonus: { jaw: 3, strength: 2, ferocity: 2 },     description: 'A tooth from a Volcanic Rex. Gets hotter during combat. This is not metaphorical.' },
  { id: 'apex_fang',           name: 'Apex Fang',            slot: 'jaws',      emoji: '💀', icon: 'game-icons:skull-sabertooth',   levelReq: 10, price: 1250, statBonus: { jaw: 4, strength: 3, ferocity: 2 },     description: 'The largest fang Grubclaw has ever worked with. He won\'t say where it\'s from. You don\'t ask.' },

  // ── Claws (strike weapons, gauntlets) ─────────────────────────────────────
  { id: 'stone_club',          name: 'Stone Club',           slot: 'claws',     emoji: '🪨', icon: 'game-icons:stone-axe',          levelReq: 1,  price: 100,  statBonus: { strength: 1, stamina: 1 },              description: 'A rock lashed to a stick. Heavy, slow, and deeply effective.' },
  { id: 'claw_gauntlet',       name: 'Claw Gauntlet',        slot: 'claws',     emoji: '🤜', icon: 'game-icons:wolverine-claws',    levelReq: 2,  price: 165,  statBonus: { strength: 1, agility: 1 },              description: 'Claws mounted on a knuckle wrap. Fast and mean.' },
  { id: 'iron_claw',           name: 'Iron Claw',            slot: 'claws',     emoji: '🗡️', icon: 'game-icons:plain-dagger',       levelReq: 3,  price: 200,  statBonus: { strength: 2, agility: 1 },              description: 'Forged by Grubclaw himself. With three fingers. You can tell.' },
  { id: 'raptor_talon',        name: 'Raptor Talon',         slot: 'claws',     emoji: '⚔️', icon: 'game-icons:claws',              levelReq: 5,  price: 400,  statBonus: { agility: 2, ferocity: 2, strength: 1 }, description: 'A dismounted raptor talon, sharpened to surgical precision. The raptor was unhappy about this.' },
  { id: 'bone_maul',           name: 'Bone Maul',            slot: 'claws',     emoji: '🏏', icon: 'game-icons:spiked-mace',        levelReq: 6,  price: 475,  statBonus: { strength: 3, stamina: 1, agility: -1 }, description: 'Enormous. Slow. When it connects, debates end.' },
  { id: 'warlord_spear',       name: "Warlord's Spear",      slot: 'claws',     emoji: '🔱', icon: 'game-icons:barbed-spear',         levelReq: 9,  price: 950,  statBonus: { strength: 3, agility: 1, ferocity: 2 }, description: 'A spear of unknown origin. The engraving suggests it has ended several careers.' },

  // ── Body (armor, hides, plating) ──────────────────────────────────────────
  { id: 'hide_wrap',           name: 'Hide Wrap',            slot: 'body',      emoji: '🧣', icon: 'game-icons:leather-armor',      levelReq: 1,  price: 75,   statBonus: { hide: 1 },                              description: 'Dried lizard hide, wrapped around the torso. Stylish in a primitive sort of way.' },
  { id: 'mud_coating',         name: 'Hardened Mud Coat',    slot: 'body',      emoji: '🟫', icon: 'game-icons:breastplate',         levelReq: 1,  price: 115,  statBonus: { hide: 1, stamina: 1 },                  description: 'Baked mud applied in layers. Insulating. Itchy. Effective.' },
  { id: 'bone_plate',          name: 'Bone Plating',         slot: 'body',      emoji: '🦴', icon: 'game-icons:metal-plate',              levelReq: 3,  price: 225,  statBonus: { hide: 2, constitution: 1 },             description: 'Actual bones, strapped on for protection. Effective and definitely not cursed.' },
  { id: 'shell_pauldrons',     name: 'Shell Pauldrons',      slot: 'body',      emoji: '🐢', icon: 'game-icons:turtle-shell',       levelReq: 3,  price: 250,  statBonus: { hide: 2, stamina: 1 },                  description: 'Shoulder guards made from turtle shells. Grubclaw is proud of the craftsmanship.' },
  { id: 'raptor_hide',         name: 'Raptor Hide Vest',     slot: 'body',      emoji: '🐆', icon: 'game-icons:animal-hide',        levelReq: 4,  price: 325,  statBonus: { hide: 1, agility: 1, constitution: 1 }, description: 'Surprisingly light for its protection. The raptor was fast. The armor carries that energy.' },
  { id: 'croc_armor',          name: 'Croc Scale Armor',     slot: 'body',      emoji: '🐊', icon: 'game-icons:scale-mail',         levelReq: 6,  price: 500,  statBonus: { hide: 3, constitution: 2, agility: -1 }, description: 'Heavy. Smells faintly of swamp. The protection is worth it.' },
  { id: 'spine_plate',         name: 'Stego Spine Plate',    slot: 'body',      emoji: '🦔', icon: 'game-icons:spiked-armor',       levelReq: 7,  price: 650,  statBonus: { hide: 3, ferocity: 1, constitution: 2 }, description: 'Plates from a Stegosaurus. Grubclaw added extra spikes. He didn\'t need to.' },
  { id: 'ember_plate',         name: 'Ember Plate',          slot: 'body',      emoji: '🌋', icon: 'game-icons:fire-bowl',          levelReq: 9,  price: 1000, statBonus: { hide: 4, constitution: 2, ferocity: 1, agility: -1 }, description: 'Forged from volcanic scales. Hot to the touch. You get used to it.' },
  { id: 'rex_hide_armor',      name: 'Rex Hide Full Armor',  slot: 'body',      emoji: '🦖', icon: 'game-icons:lamellar',           levelReq: 10, price: 1300, statBonus: { hide: 5, constitution: 3, agility: -1 }, description: 'Rex hide, bone-riveted, heat-treated. Grubclaw won\'t say how many fingers he lost making this.' },

  // ── Head (helmets, horns, masks) ──────────────────────────────────────────
  { id: 'war_paint',           name: 'War Paint',            slot: 'head',      emoji: '🎨', icon: 'game-icons:tribal-mask',          levelReq: 1,  price: 90,   statBonus: { roar: 1, ferocity: 1 },                 description: 'Made from berries and intimidation. Looks terrifying. Is terrifying.' },
  { id: 'war_horn',            name: 'War Horn',             slot: 'head',      emoji: '📯', icon: 'game-icons:horned-helm',        levelReq: 4,  price: 350,  statBonus: { roar: 2, ferocity: 1, strength: 1 },    description: 'Strapped to your head. Increases gore damage. Looks absolutely insane.' },
  { id: 'predator_mask',       name: 'Predator Mask',        slot: 'head',      emoji: '🎭', icon: 'game-icons:skull-mask',         levelReq: 5,  price: 425,  statBonus: { roar: 1, ferocity: 2, cunning: 1 },     description: 'A carved skull mask. The crowd always reacts. Your opponent usually does too.' },
  { id: 'warlord_crest',       name: "Warlord's Crest",      slot: 'head',      emoji: '👑', icon: 'game-icons:laurel-crown',       levelReq: 10, price: 1125, statBonus: { roar: 3, ferocity: 2, cunning: 2 },     description: 'Worn by the greatest arena champions. Grubclaw found it. He will not say where.' },

  // ── Tail (tail weapons, attachments) ──────────────────────────────────────
  { id: 'tail_wrap',           name: 'Spiked Tail Wrap',     slot: 'tail',      emoji: '🌵', icon: 'game-icons:spiked-tail',        levelReq: 1,  price: 90,   statBonus: { strength: 1, cunning: 1 },              description: 'Spikes bound to the tail. More of a deterrent than a weapon. Still counts.' },
  { id: 'tail_spike',          name: 'Iron Tail Spike',      slot: 'tail',      emoji: '📌', icon: 'game-icons:spikeball',              levelReq: 4,  price: 300,  statBonus: { strength: 2, cunning: 2 },              description: 'A hardened iron spike strapped to the tail. Hits things behind you. Counts double.' },
  { id: 'tail_blade',          name: 'Champion Tail Blade',  slot: 'tail',      emoji: '⚡', icon: 'game-icons:blade-bite',       levelReq: 7,  price: 600,  statBonus: { strength: 3, cunning: 2, stamina: 1 },  description: 'A sharpened plate bolted to the tail. Grubclaw\'s finest attachment work. Do not ask about the installation process.' },
  { id: 'stego_tailclub',      name: 'Stego Tail Club',      slot: 'tail',      emoji: '🔨', icon: 'game-icons:stegosaurus-scales',        levelReq: 9,  price: 950,  statBonus: { strength: 4, cunning: 2, ferocity: 1 }, description: 'A genuine Stegosaurus tail club. Repurposed. The Stegosaurus had some strong feelings about this.' },

  // ── Accessory (charms, totems, necklaces) ─────────────────────────────────
  { id: 'lucky_fossil',        name: 'Lucky Fossil',         slot: 'accessory', emoji: '🪨', icon: 'game-icons:fossil',             levelReq: 1,  price: 50,   statBonus: { cunning: 1 },                           description: 'A fossil of something that clearly did NOT survive. Lucky.' },
  { id: 'sinew_brace',         name: 'Sinew Brace',          slot: 'accessory', emoji: '🪢', icon: 'game-icons:rope-coil',          levelReq: 1,  price: 90,   statBonus: { stamina: 1, agility: 1 },               description: 'Tight wrapping around the limbs. Improves endurance and reaction time.' },
  { id: 'claw_sharpener',      name: 'Claw Sharpener',       slot: 'accessory', emoji: '💍', icon: 'game-icons:bowie-knife',          levelReq: 2,  price: 150,  statBonus: { jaw: 1, ferocity: 1 },                  description: 'A ring fitted with a whetstone edge. Your natural weapons stay sharp.' },
  { id: 'stamina_totem',       name: 'Stamina Totem',        slot: 'accessory', emoji: '🪆', icon: 'game-icons:totem-mask',         levelReq: 4,  price: 300,  statBonus: { stamina: 2, constitution: 1 },          description: 'A carved idol of a dinosaur not getting tired. Inspirational.' },
  { id: 'speed_anklet',        name: 'Swiftbone Anklet',     slot: 'accessory', emoji: '💨', icon: 'game-icons:wind-hole',          levelReq: 4,  price: 275,  statBonus: { agility: 2, cunning: 1 },               description: 'Lightweight bones strung around the ankle. Opponents notice the difference.' },
  { id: 'alpha_fang_necklace', name: 'Alpha Fang Necklace',  slot: 'accessory', emoji: '🦴', icon: 'game-icons:necklace',           levelReq: 7,  price: 625,  statBonus: { roar: 2, ferocity: 2, cunning: 1 },     description: 'A trophy fang on a sinew cord. Other dinosaurs notice it. They do not comment.' },
  { id: 'volcano_shard',       name: 'Volcano Shard Charm',  slot: 'accessory', emoji: '🌋', icon: 'game-icons:hot-surface',        levelReq: 8,  price: 750,  statBonus: { ferocity: 3, strength: 1, roar: 1 },    description: 'A fragment of cooled lava, somehow still warm. Makes the wearer angrier.' },
  { id: 'warlord_totem',       name: "Warlord's Totem",      slot: 'accessory', emoji: '⚔️', icon: 'game-icons:war-axe',            levelReq: 10, price: 1050, statBonus: { stamina: 3, constitution: 2, cunning: 2 }, description: 'A carved totem carried by legendary fighters. The carvings depict things best not examined closely.' },

  // ── Town 2 — The Ashpit ───────────────────────────────────────────────────
  { id: 'scorched_maw',        name: 'Scorched Maw',         slot: 'jaws',      emoji: '🔥', icon: 'game-icons:fire-breath',        levelReq: 11, price: 1600, statBonus: { jaw: 4, ferocity: 3 },                         description: 'Fang-work coated in heat-treated volcanic resin. Bites don\'t just cut — they sear.', town: 2 },
  { id: 'obsidian_bite',       name: 'Obsidian Bite Brace',  slot: 'jaws',      emoji: '🌑', icon: 'game-icons:butterfly-knife',     levelReq: 16, price: 2900, statBonus: { jaw: 5, ferocity: 3, roar: 2 },                 description: 'Obsidian shards fitted between existing teeth. Scorcha won\'t tell you how many fittings went wrong. The look on her face is its own answer.', town: 2 },
  { id: 'ashglass_knuckle',    name: 'Ashglass Knuckles',    slot: 'claws',     emoji: '🌋', icon: 'game-icons:fist',               levelReq: 12, price: 1750, statBonus: { strength: 3, ferocity: 3 },                     description: 'Fused volcanic glass over each knuckle. They look expensive because they are.', town: 2 },
  { id: 'cinder_gauntlet',     name: 'Cinder Gauntlet',      slot: 'claws',     emoji: '💢', icon: 'game-icons:gauntlet',           levelReq: 18, price: 3400, statBonus: { strength: 4, ferocity: 3, stamina: 2 },         description: 'Forged in the pit itself. The heat never fully leaves them. Neither does the intent.', town: 2 },
  { id: 'volcanic_scale_vest', name: 'Volcanic Scale Vest',  slot: 'body',      emoji: '🌋', icon: 'game-icons:scale-mail',         levelReq: 11, price: 1800, statBonus: { hide: 4, constitution: 3, ferocity: 1 },        description: 'Scales stripped from a lava croc, cured in ash and time. Heavy. Excellent.', town: 2 },
  { id: 'inferno_plate',       name: 'Inferno Plate',        slot: 'body',      emoji: '🔥', icon: 'game-icons:fire-shield',        levelReq: 19, price: 4200, statBonus: { hide: 6, constitution: 4, ferocity: 2, agility: -1 }, description: 'Full chest plating from The Ashpit\'s own forge. Scorcha made three of these. One is still available. She won\'t say what happened to the others.', town: 2 },
  { id: 'ashpit_warcrown',     name: 'Ashpit Warcrown',      slot: 'head',      emoji: '👑', icon: 'game-icons:thorned-arrow',      levelReq: 13, price: 2200, statBonus: { roar: 3, ferocity: 3 },                         description: 'A jagged crown of cooled lava-rock. It serves no structural purpose. The effect on opponents is purely psychological. It works.', town: 2 },
  { id: 'magma_visored_helm',  name: 'Magma Visor Helm',     slot: 'head',      emoji: '🎭', icon: 'game-icons:visored-helm',       levelReq: 20, price: 4500, statBonus: { roar: 4, ferocity: 3, constitution: 2 },        description: 'A full helm with a visor slit that glows when the wearer gets angry. According to Scorcha, the glowing is "a feature."', town: 2 },
  { id: 'cinder_lash',         name: 'Cinder Lash',          slot: 'tail',      emoji: '🌪️', icon: 'game-icons:whip',               levelReq: 12, price: 1900, statBonus: { strength: 3, ferocity: 2, stamina: 2 },         description: 'A flexible volcanic-glass flail fitted to the tail. Leaves marks. Plural.', town: 2 },
  { id: 'eruption_tail_spike', name: 'Eruption Tail Spike',  slot: 'tail',      emoji: '🌋', icon: 'game-icons:volcano',            levelReq: 17, price: 3200, statBonus: { strength: 5, ferocity: 3, roar: 1 },            description: 'A two-foot spike of hardened magma-rock bolted to the tail. Scorcha calls it "the full stop." You understand why.', town: 2 },
  { id: 'ember_shard_amulet',  name: 'Ember Shard Amulet',   slot: 'accessory', emoji: '🔥', icon: 'game-icons:gem-pendant',            levelReq: 11, price: 1650, statBonus: { ferocity: 3, roar: 2 },                         description: 'A fragment of active lava rock on a heat-tempered chain. It is warm against the skin. That\'s not a comfort thing. That\'s a warning thing.', town: 2 },
  { id: 'ashpit_brand_totem',  name: 'Ashpit Brand Totem',   slot: 'accessory', emoji: '🌑', icon: 'game-icons:tribal-mask',        levelReq: 18, price: 3600, statBonus: { ferocity: 3, jaw: 3, roar: 2 },                 description: 'Carved from basalt and branded with the mark of The Ashpit\'s most notorious past champions. Scorcha sells it reluctantly and won\'t say why.', town: 2 },

  // ── Town 3 — The Murkfen ─────────────────────────────────────────────────
  { id: 'mire_fang',           name: 'Mire Fang',             slot: 'jaws',      emoji: '🦷', icon: 'game-icons:snake-tongue',       levelReq: 22, price: 5500,  statBonus: { jaw: 4, cunning: 3 },                           description: 'A fang salvaged from the fen\'s deeper residents. She didn\'t tell you what it came from. The fang was apparently fine with leaving.', town: 3 },
  { id: 'venombarb_bite',      name: 'Venombarb Bite',        slot: 'jaws',      emoji: '💧', icon: 'game-icons:wasp-sting',              levelReq: 30, price: 9200,  statBonus: { jaw: 5, cunning: 4, agility: 2 },               description: '"What\'s the barb do?" you ask. Brine looks at you for a long moment. "Bites twice," she says. That is the entire explanation.', town: 3 },
  { id: 'swamp_knifehand',     name: 'Swamp Knifehand',       slot: 'claws',     emoji: '🌿', icon: 'game-icons:bone-knife',              levelReq: 23, price: 6000,  statBonus: { agility: 4, cunning: 3 },                       description: 'Reed-fiber-wrapped bone blades, slim and quiet. They don\'t make a sound on entry. Brine says that\'s the point of them.', town: 3 },
  { id: 'fog_strike_talons',   name: 'Fog-Strike Talons',     slot: 'claws',     emoji: '🌫️', icon: 'game-icons:claw-slashes',       levelReq: 33, price: 10500, statBonus: { agility: 5, cunning: 4, stamina: 2 },           description: '"You\'ll want to strike before they see you," Brine explains. "These help with that." She does not clarify how.', town: 3 },
  { id: 'murk_weave_vest',     name: 'Murk-Weave Vest',       slot: 'body',      emoji: '🌿', icon: 'game-icons:leather-vest',               levelReq: 22, price: 5800,  statBonus: { stamina: 4, agility: 3 },                       description: 'Woven from the reeds and hides of things that lived in the bog. Lighter than it looks. Moves like water. Brine wove it herself. She won\'t say when.', town: 3 },
  { id: 'siltscale_armor',     name: 'Siltscale Full Armor',  slot: 'body',      emoji: '🐊', icon: 'game-icons:chain-mail',         levelReq: 34, price: 12000, statBonus: { stamina: 5, hide: 4, agility: 3, strength: -1 }, description: '"The scales come from the deep channel," Brine says. "Don\'t ask about the channel." You were about to ask about the channel.', town: 3 },
  { id: 'fogveil_hood',        name: 'Fogveil Hood',          slot: 'head',      emoji: '🌫️', icon: 'game-icons:hood',               levelReq: 24, price: 6500,  statBonus: { cunning: 4, agility: 3 },                       description: 'A hood treated with bog-smoke, rendered in a grey that matches the Murkfen mist exactly. "You\'re not invisible," Brine says. "You\'re just difficult to think about."', town: 3 },
  { id: 'murk_crown_helm',     name: 'Murk Crown Helm',       slot: 'head',      emoji: '🐸', icon: 'game-icons:leaf-swirl',         levelReq: 36, price: 13500, statBonus: { cunning: 5, stamina: 4, agility: 2 },           description: 'Brine keeps it behind the counter and only brings it out when she thinks you\'re ready. She brought it out. You\'re apparently ready.', town: 3 },
  { id: 'bog_lash',            name: 'Bog Lash',              slot: 'tail',      emoji: '💧', icon: 'game-icons:flail',              levelReq: 23, price: 6200,  statBonus: { stamina: 3, cunning: 3, agility: 2 },           description: 'A weighted reed-and-bone tail flail that moves through fog like it isn\'t there. Which is the point. The target learns this at roughly the same moment.', town: 3 },
  { id: 'silt_sting',          name: 'Silt-Sting Spike',      slot: 'tail',      emoji: '🌿', icon: 'game-icons:wasp-sting',            levelReq: 35, price: 11500, statBonus: { stamina: 4, cunning: 4, strength: 2 },          description: '"It\'s coated," Brine tells you. "In what?" "In something from the channel." You don\'t press the channel question again.', town: 3 },
  { id: 'deep_channel_stone',  name: 'Deep Channel Stone',    slot: 'accessory', emoji: '💧', icon: 'game-icons:minerals',           levelReq: 22, price: 5500,  statBonus: { cunning: 3, stamina: 3 },                       description: 'A smooth stone from the bottom of the Murkfen\'s deepest channel. Brine found it there years ago. She says it knows things. She says it quieter than she says other things.', town: 3 },
  { id: 'fenbinder_cord',      name: 'Fenbinder Cord',        slot: 'accessory', emoji: '🪢', icon: 'game-icons:knot',               levelReq: 32, price: 8500,  statBonus: { cunning: 4, agility: 4, stamina: 2 },           description: '"What does it bind?" you ask. Brine looks at the cord for a moment. "Distance," she says. "Between where you are and where you need to be." You tie it on. It feels correct.', town: 3 },

  // ── Town 4 — The Hollow Crown ─────────────────────────────────────────────
  { id: 'frost_fang',          name: 'Frost Fang',            slot: 'jaws',      emoji: '🧊', icon: 'game-icons:frozen-block',       levelReq: 38, price: 16000, statBonus: { jaw: 5, strength: 4 },                          description: 'Pulled from a glacier fissure by Voryn. Edges ground to a finish that doesn\'t need describing. You will notice it in the first round.', town: 4 },
  { id: 'summit_shear',        name: 'Summit Shear',          slot: 'jaws',      emoji: '⛰️', icon: 'game-icons:jawbone',                levelReq: 46, price: 24000, statBonus: { jaw: 6, strength: 5, constitution: 2 },         description: 'Voryn places it on the counter without ceremony. "It has ended nine careers," Voryn says. "The owners are all alive. They retired voluntarily." A pause. "Mostly."', town: 4 },
  { id: 'glacial_strike',      name: 'Glacial Strike Claws',  slot: 'claws',     emoji: '🧊', icon: 'game-icons:ice-spear',          levelReq: 38, price: 17000, statBonus: { strength: 5, constitution: 3 },                 description: 'Forged at altitude, tempered in melt water that has been cold for approximately twelve thousand years. Voryn says nothing about this. The cold says enough.', town: 4 },
  { id: 'ironpeak_gauntlet',   name: 'Ironpeak Gauntlet',     slot: 'claws',     emoji: '🏔️', icon: 'game-icons:gauntlet',           levelReq: 47, price: 26000, statBonus: { strength: 6, constitution: 4, hide: 2 },        description: '"These are for the ones who are still fighting in the final rounds," Voryn says. It is unclear if this is a compliment or a requirement.', town: 4 },
  { id: 'glacierhide_vest',    name: 'Glacierhide Vest',      slot: 'body',      emoji: '🧊', icon: 'game-icons:ice-shield',         levelReq: 39, price: 18000, statBonus: { hide: 6, constitution: 4 },                     description: 'Hide from something that lived above the snowline. It is very thick. Voryn says: "Cold makes things harder." This applies to the hide. Possibly also to Voryn.', town: 4 },
  { id: 'vault_plate',         name: 'Vault Plate',           slot: 'body',      emoji: '🏔️', icon: 'game-icons:lamellar',    levelReq: 48, price: 28000, statBonus: { hide: 7, constitution: 5, strength: 2, agility: -2 }, description: 'Full summit plating. Voryn keeps one set in stock at a time. Either you\'re ready or you aren\'t, and Voryn can tell the difference.', town: 4 },
  { id: 'cold_eye_visor',      name: 'Cold Eye Visor',        slot: 'head',      emoji: '❄️', icon: 'game-icons:stealth-bomber',     levelReq: 38, price: 16500, statBonus: { constitution: 4, hide: 4 },                     description: '"It doesn\'t help you see better," Voryn says. "It helps you see clearly." There is a difference, apparently.', town: 4 },
  { id: 'summit_warcrown',     name: 'Summit Warcrown',       slot: 'head',      emoji: '👑', icon: 'game-icons:crown-of-thorns',    levelReq: 49, price: 30000, statBonus: { constitution: 5, hide: 5, strength: 3 },        description: '"You\'ve earned the right to it," Voryn says. That is the most words Voryn has used this season.', town: 4 },
  { id: 'glacier_tail_spike',  name: 'Glacier Tail Spike',    slot: 'tail',      emoji: '🧊', icon: 'game-icons:ice-bolt',           levelReq: 40, price: 19000, statBonus: { strength: 5, hide: 3, stamina: 2 },             description: 'Chiseled from a single spar of glacial ice-rock. Voryn says it won\'t shatter. Voryn does not make predictions lightly.', town: 4 },
  { id: 'peak_hammertail',     name: 'Peak Hammertail',       slot: 'tail',      emoji: '⛰️', icon: 'game-icons:flanged-mace',         levelReq: 50, price: 27000, statBonus: { strength: 7, constitution: 3, hide: 2 },        description: '"This ends fights," Voryn says, setting it on the counter. A long silence. "It has ended several that should have gone longer." This appears to be the sales pitch.', town: 4 },
  { id: 'altitude_sigil',      name: 'Altitude Sigil',        slot: 'accessory', emoji: '❄️', icon: 'game-icons:rune-stone',         levelReq: 38, price: 16000, statBonus: { constitution: 4, hide: 3 },                     description: 'Every fighter at the Hollow Crown has seen one. Most are in the possession of people who have been here a while. Voryn sells it without comment.', town: 4 },
  { id: 'summit_mantle',       name: 'Summit Mantle',         slot: 'accessory', emoji: '🏔️', icon: 'game-icons:cloak',              levelReq: 48, price: 25000, statBonus: { constitution: 5, hide: 4, strength: 2 },        description: '"The ones who fight here long enough stop needing it," Voryn says. "But it helps in the beginning." You put it on and feel the weight of the altitude less.', town: 4 },
]
...
export const TAVERN_ITEMS: TavernItem[] = [
  ...
  },
  {
    ...
    emoji: '🍲',
    icon: 'game-icons:boiling-bubbles',
  ...
  },
  {
    ...
    emoji: '🌩️',
    icon: 'game-icons:thunder-struck',
